using AuthenticationAndAuthorizeDemo.Filter;
using Microsoft.OpenApi.Models;

namespace AuthenticationAndAuthorizeDemo
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Filters.Add(new BasicAuthenticationFilterAttribute());
            });
            ...
            // services.AddScoped<IAuthenticationFilter, BasicAuthenticationFilterAttribute>();
        }
